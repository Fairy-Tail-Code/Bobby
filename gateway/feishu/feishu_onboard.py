"""Feishu/Lark onboarding — scan-to-create application and verify credentials.

Provides QR code-based registration flow for automatically creating
a Feishu/Lark bot application with correct permissions.
"""
...
def _post_registration(base_url: str, body: dict[str, str]) -> dict:
    """POST form-encoded data to registration endpoint, return parsed JSON.
...
def _init_registration(domain: str = "feishu") -> None:
    """Verify that environment supports client_secret auth.
...
def _poll_registration(
    *,
    ...
    """Poll until user scans QR code, or timeout/denial.
...
def _render_qr(url: str) -> bool:
    """Try to render a QR code in terminal. Returns True if successful."""
...
def _qr_register_inner(
    *,
    ...
    # Probe bot — best-effort, don't fail registration
