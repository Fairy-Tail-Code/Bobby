...
- Use `mcp__shell__run_short_command` only for lightweight, single-target inspection such as `python --version`, `npm list --depth=0`, or `cat package.json`. Never for recursive traversal.
